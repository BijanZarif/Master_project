...
\todo[inline]{I don't think I really need this section, I can say everything in the entire model with the elastic constant}
...
The vector $\mathbf{v}$ can be split in its normal and tangential components, as follows: $\mathbf{v} = v_n \mathbf{n} + v_t \mathbf{t}$. Substituting the $\mathbf{v}$ in \eqref{eq:nitsche:5} and simplifying we have
