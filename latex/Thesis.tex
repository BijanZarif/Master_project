...
\section{Navier-Stokes + ALE with elastic walls (Eleonora 2)}
...
\[
\begin{aligned}
u = \tilde{u}, \qquad & \text{ in } \partial \Omega_{TB} \\
(\nu \nabla u - pI)\cdot n = \pm ky \qquad & \text{ on } \partial \Omega_C \cup \partial \Omega_T
\end{aligned}.
\]
...
\left\{  
\begin{aligned}
-\Delta w = 0, \qquad & \text{ on } \partial \Omega_F (t) \\
w = u, \qquad & \text{ on } \partial \Omega_F (t)
\end{aligned}
\right.
\]
