...
\todo[inline]{comment these plots and write conclusions.
Vegard:
3) When the wall starts moving, will this movement cause forces on the cord which will make a syrinx grow or decrease?}
...
%\caption{The CSF flux decreases when }
%\end{figure}
...
\bibitem{bilston} L. E. Bilston, M. A. Stoodley, D. F. Fletcher, \emph{The of the relative timing of arterial and subarachnoid space pulse waves on spinal perivascular cerebrospinal fluid flow as a possible factor in syrinx development}, J. Neurosurg. 112:808-813, 2010.
