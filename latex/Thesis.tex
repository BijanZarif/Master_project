...
We now want to compare different quantities between the fixed and the moving meshes.   \cite{elliott}  \cite{hung} \cite{bertram} 
...
\begin{figure}[h!]
\centering
\includegraphics[width=\textwidth]{images/x_component_ampl.png}
\caption{}
\end{figure}
