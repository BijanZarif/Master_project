...
\hline
$N$ & $|| u_{exact} - u_h ||_{L^2}$ & $ | u_{exact} - u_h |_{H^1}$ & $|| p_{exact} - p_h ||_{L^2} $ & Rate \\
\hline
$ 4 $ & $2.7373 \times 10^{-14}$ & $3.2162 \times 10^{-13}$ & $4.8674 \times 10^{-13}$ & \\
\hline
$ 8$ & $1.3173  \times 10^{-12}$ & $7.5841 \times 10^{-11}$ & $1.4330 \times 10^{-10}$ & $2.9834$ \\
\hline
$ 16 $ & $ 8.4791 \times 10^{-14}$ & $9.1285 \times 10^{-12}$ & $3.5083 \times 10^{-11}$ & $ 2.9952 $ \\
\hline
$ 32$ & $9.0508 \times 10^{-14}$ & $1.6039 \times 10^{-11}$ & $1.2406 \times 10^{-10}$ & $ 2.9987 $  \\
\hline
$ 64$ & $6.3504 \times 10^{-13}$ & $9.5275 \times 10^{-11}$ & $1.4692 \times 10^{-9}$ & $ 2.9997 $ \\
\hline
\end{tabular}
\end{center}
...
\begin{tabular}{| c | c | c | c | c |}
\hline
$N$ & $|| u_{exact} - u_h ||_{L^2}$ & $ | u_{exact} - u_h |_{H^1}$ & $|| p_{exact} - p_h ||_{H^1} $ & Rate \\
\hline
$ 4 $ & $1.9388 \times 10^{-3}$ & $5.0548 \times 10^{-2}$ & $2.4515 \times 10^{-3}$ & \\
\hline
$ 8$ & $2.4515  \times 10^{-4}$ & $1.2733 \times 10^{-2}$ & $2.2031 \times 10^{-4}$ & $2.9834$ \\
\hline
$ 16 $ & $ 3.0745 \times 10^{-5}$ & $3.1896 \times 10^{-3}$ & $3.7982 \times 10^{-5}$ & $2.9952$ \\
\hline
$ 32$ & $3.8465 \times 10^{-6}$ & $7.9780 \times 10^{-4}$ & $6.6700 \times 10^{-6}$ & $ 2.9987 $ \\
\hline
$ 64$ & $4.8092 \times 10^{-7}$ & $1.9948 \times 10^{-4}$ & $1.1775 \times 10^{-6}$ & $2.9997$ \\
\hline
\end{tabular}
\end{center}
...
%\caption{Order 3, $IMAX = JMAX = 20, R_1 = 1, R_2 = 2$.}
\end{figure}
\vspace{1cm}
