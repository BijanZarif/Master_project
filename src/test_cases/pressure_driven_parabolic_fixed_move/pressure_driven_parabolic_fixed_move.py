...
for N in NN:
    ...
    for dt in h:
        ...
        p_exact = 1 - x[0]
        w_move = Expression(("0.05", "0.05"), degree = 2, t=0.0)   # ALE
        
        ufile = File("results/velocity_fixed_move.pvd")
        pfile = File("results/pressure_fixed_move.pvd")
        ...
        left_wall_w = DirichletBC(W, w_move, fd, 1)   
        right_wall_w = DirichletBC(W, w_move, fd, 2)  
        top_wall_w = DirichletBC(W, w_move, fd, 3) # top
        bottom_wall_w = DirichletBC(W, w_move , fd, 4)
